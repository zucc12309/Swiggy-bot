...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("telegram_id", sa.String(), nullable=False, unique=True, index=True),
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("swiggy_oauth_client_id", sa.String(), nullable=True),
        ...
        sa.Column("swiggy_selected_address_id", sa.String(), nullable=True),
        sa.Column("swiggy_selected_address_label", sa.String(), nullable=True),
        sa.Column("swiggy_selected_lat", sa.String(), nullable=True),
        sa.Column("swiggy_selected_lng", sa.String(), nullable=True),
        sa.Column("reminder_lead_hours", sa.Integer(), default=12),
        sa.Column("max_auto_charge", sa.Integer(), default=100000),
    ...
    op.create_table(
        "schedules",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("telegram_id", sa.String(), sa.ForeignKey("users.telegram_id"),
                  nullable=False, index=True),
        sa.Column("name", sa.String(), nullable=False),
        sa.Column("freq_value", sa.Integer(), nullable=False),
        sa.Column("freq_unit", sa.Enum("days", "weeks", "months", name="frequencyunit"),
                  nullable=False),
        sa.Column("anchor_day", sa.String(), nullable=True),
        sa.Column("next_run", sa.DateTime(timezone=True), nullable=False),
        sa.Column("status", sa.Enum("active", "paused", "cancelled", name="schedulestatus"),
                  default="active"),
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("food", "grocery", "dineout", name="ordertype"),
                  nullable=False),
        sa.Column("swiggy_order_id", sa.String(), nullable=True, unique=True),
        sa.Column("schedule_id", sa.Integer(), nullable=True),
        sa.Column("status", sa.Enum("pending_confirmation", "placed", "confirmed",
                                    "picked_up", "delivered", "cancelled", "failed",
                                    name="orderstatus"),
        ...
        sa.Column("payment_method", sa.String(), nullable=True, default="COD"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), onupdate=sa.func.now()),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("telegram_id", sa.String(), nullable=False, index=True),
        sa.Column("product_spin_id", sa.String(), nullable=False),
        ...
        sa.Column("status", sa.Enum("active", "fired", "snoozed", "deleted",
                                    name="pricealertstatus"),
                  default="active"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
